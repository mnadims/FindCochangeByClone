...
\multicolumn{9}{l}{\textit{\textbf{* Tools are listed in alphabetic order in the left-most column.}}}                                                                                                                                                                                                                                                      \\
\multicolumn{9}{l}{\textit{\textbf{\begin{tabular}[c]{@{}l@{}}* The numbers under each subject system represent the ranks of the tools\\  for that system.\end{tabular}}}}                                                                                                                                                                                           
\end{tabular}
\end{table}
%%% ==================================================
...
%%% --- Final Ranking ---------------------
\begin{table}[]
\caption{\label{tab:final-ranking}\textsc{Final Rank of Clone Detectors Considering all the Subject Systems}}
\centering
